...
TrainCar* createSampleTrain3() //this function manually creates a pre-defined train for some of the test cases, because some students may not be able to complete addCar correctly
{
    TrainCar* head = new TrainCar;
    head->type = HEAD; head->load = 0; head->maxLoad = 0; head->prev = head->next = nullptr;
    TrainCar* cars[7];
    ...
    cars[5] = new TrainCar;
    cars[6] = new TrainCar;
    cars[0]->type = WOOD; cars[0]->load = 30; cars[0]->maxLoad = 400; cars[0]->prev = cars[0]->next = nullptr;
    cars[1]->type = OIL; cars[1]->load = 10; cars[1]->maxLoad = 100; cars[1]->prev = cars[1]->next = nullptr;
    cars[2]->type = COAL; cars[2]->load = 40; cars[2]->maxLoad = 200; cars[2]->prev = cars[2]->next = nullptr;
    cars[3]->type = STEEL; cars[3]->load = 20; cars[3]->maxLoad = 300; cars[3]->prev = cars[3]->next = nullptr;
    cars[4]->type = COAL; cars[4]->load = 5; cars[4]->maxLoad = 500; cars[4]->prev = cars[4]->next = nullptr;
    cars[5]->type = WOOD; cars[5]->load = 4; cars[5]->maxLoad = 600; cars[5]->prev = cars[5]->next = nullptr;
    cars[6]->type = WOOD; cars[6]->load = 3; cars[6]->maxLoad = 700; cars[6]->prev = cars[6]->next = nullptr;
    head->next = cars[0];
    cars[0]->next = cars[1];
    cars[1]->next = cars[2];
    cars[2]->next = cars[3];
...
TrainCar* createSampleTrain4() //this function manually creates a pre-defined train for some of the test cases, because some students may not be able to complete addCar correctly
{
    TrainCar* head = new TrainCar;
    head->type = HEAD; head->load = 0; head->maxLoad = 0; head->prev = head->next = nullptr;
    TrainCar* cars[7];
    ...
    cars[5] = new TrainCar;
    cars[6] = new TrainCar;
    cars[0]->type = SUGAR; cars[0]->load = 130; cars[0]->maxLoad = 400; cars[0]->prev = cars[0]->next = nullptr;
    cars[1]->type = SUGAR; cars[1]->load = 10; cars[1]->maxLoad = 100; cars[1]->prev = cars[1]->next = nullptr;
    cars[2]->type = SUGAR; cars[2]->load = 40; cars[2]->maxLoad = 200; cars[2]->prev = cars[2]->next = nullptr;
    cars[3]->type = SUGAR; cars[3]->load = 20; cars[3]->maxLoad = 300; cars[3]->prev = cars[3]->next = nullptr;
    cars[4]->type = SUGAR; cars[4]->load = 51; cars[4]->maxLoad = 500; cars[4]->prev = cars[4]->next = nullptr;
    cars[5]->type = SUGAR; cars[5]->load = 14; cars[5]->maxLoad = 600; cars[5]->prev = cars[5]->next = nullptr;
    cars[6]->type = SUGAR; cars[6]->load = 113; cars[6]->maxLoad = 700; cars[6]->prev = cars[6]->next = nullptr;
    head->next = cars[0];
    cars[0]->next = cars[1];
    cars[1]->next = cars[2];
    cars[2]->next = cars[3];
...
int main()
{
    ...
    else if(testCase == 2)
    {
        ...
        printTrain(train);
        cout << endl;
        cout << "Its load and maxLoad must be set to 0 according to the description: " << train->load << "," << train->maxLoad << endl;
        cout << "Calling deallocateTrain..." << endl;
        deallocateTrain(train);
    }
    ...
    {   
        ...
        for(int j=0; j<20; j++)
        {
            cout << "addCar: " << addCar(train, j, WOOD, j) << endl;
            printTrain(train);
            cout << endl;
        }
        cout << "Calling deallocateTrain..." << endl;
    ...
    {   
        ...
        for(int j=0; j<20; j++)
        {
            cout << "addCar: " << addCar(train, 1, WOOD, j) << endl;
            printTrain(train);
            cout << endl;
        }
        cout << "Calling deallocateTrain..." << endl;
    ...
    {
        TrainCar* train = createSampleTrain3();
        cout << "Original train:" << endl;
        printTrain(train);
        cout << endl;
        for(int j=-1;j<10;j++)
        {
            cout << "deleteCar: " << deleteCar(train, j) << endl;
            printTrain(train);
            cout << endl;
        }
        cout << "Calling deallocateTrain..." << endl;
    ...
    else if(testCase == 13)
    {
        ...
        printTrain(train);
        cout << endl;
        cout << "swapCar(train, 2, 4): " << swapCar(train, 2, 4) << endl;
        printTrain(train);
        cout << endl;
        cout << "Calling deallocateTrain..." << endl;
        deallocateTrain(train);
    ...
    else if(testCase == 14)
    {
        ...
        printTrain(train);
        cout << endl;
        cout << "swapCar(train, 4, 4): " << swapCar(train, 4, 4) << endl;
        printTrain(train);
        cout << endl;
        cout << "swapCar(train, 4, 14): " << swapCar(train, 4, 14) << endl;
        printTrain(train);
        cout << endl;
        cout << "Calling deallocateTrain..." << endl;
        deallocateTrain(train);
    ...
    else if(testCase == 21)
    {
        ...
        for(int j=0;j<10;j++)
        {
            cout << "Calling load: " << load(train, WOOD, 300) << endl;
            printTrain(train);
            cout << endl;
        }
        cout << "Calling deallocateTrain..." << endl;
    ...
    else if(testCase == 22)
    {
        ...
        printTrain(train);
        cout << endl;
        cout << "Calling load: " << load(train, SUGAR, 1) << endl;
        printTrain(train);
        cout << endl;
        cout << "Calling load: " << load(train, SUGAR, 2) << endl;
        printTrain(train);
        cout << endl;
        cout << "Calling load: " << load(train, STEEL, 9999) << endl;
        printTrain(train);
        cout << endl;
        cout << "Calling load: " << load(train, STEEL, 1) << endl;
        printTrain(train);
        cout << endl;
        cout << "Calling deallocateTrain..." << endl;
        deallocateTrain(train);
    ...
    else if(testCase == 25)
    {
        ...
        printTrain(train);
        cout << endl;
        cout << "Calling unload: " << unload(train, SUGAR, 1) << endl;
        printTrain(train);
        cout << endl;
        cout << "Calling unload: " << unload(train, OIL, 10) << endl;
        printTrain(train);
        cout << endl;
        cout << "Calling deallocateTrain..." << endl;
        deallocateTrain(train);
    ...
    else if(testCase == 26)
    {
        ...
        for(int j=0;j<10;j++)
        {
            cout << "Calling unload: " << unload(train, WOOD, 5) << endl;
            printTrain(train);
            cout << endl;
        }
        cout << "Calling deallocateTrain..." << endl;
    ...
    {
        TrainCar* train = createSampleTrain4();
        cout << "Original train:" << endl;
        printTrain(train);
        cout << "The following one line contains the cargo stats in the required order:" << endl;
        printCargoStats(train);
    ...
    else if(testCase == 40)
    {
        ...
        cout << "Calling optimizeForMaximumPossibleCargos(train, 51)..." << endl;
        TrainCar* result = optimizeForMaximumPossibleCargos(train, 51);
        printTrain(result);
        cout << endl;
        cout << "Calling deallocateTrain..." << endl;
        deallocateTrain(result);
    ...
    else if(testCase == 41)
    {
        ...
        cout << "Calling optimizeForMaximumPossibleCargos(train, 9999999)..." << endl;
        TrainCar* result = optimizeForMaximumPossibleCargos(train, 9999999);
        printTrain(result);
        cout << endl;
        cout << "Calling deallocateTrain..." << endl;
        deallocateTrain(result);
    ...
    else if(testCase == 42)
    {
        ...
        cout << "Calling optimizeForMaximumPossibleCargos(train, 8)..." << endl;
        TrainCar* result = optimizeForMaximumPossibleCargos(train, 8);
        printTrain(result);
        cout << endl;
        cout << "Calling deallocateTrain..." << endl;
        deallocateTrain(result);
    ...
    else if(testCase == 43)
    {
        ...
        cout << "Calling optimizeForMaximumPossibleCargos(train, 377)..." << endl;
        TrainCar* result = optimizeForMaximumPossibleCargos(train, 377);
        printTrain(result);
        cout << endl;
        cout << "Calling deallocateTrain..." << endl;
        deallocateTrain(result);
    ...
    else if(testCase == 44)
    {
        ...
        cout << "Calling optimizeForMaximumPossibleCargos(train, 74)..." << endl;
        TrainCar* result = optimizeForMaximumPossibleCargos(train, 74);
        printTrain(result);
        cout << endl;
        cout << "Calling deallocateTrain..." << endl;
        deallocateTrain(result);
